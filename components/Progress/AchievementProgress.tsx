...
import { Trophy, Star, Zap, Crown, Gem, Lock, ChevronDown, ChevronUp, RotateCcw } from 'lucide-react';
import useAchievementStore, { ACHIEVEMENTS, type Achievement, type AchievementRarity } from '@/store/useAchievementStore';
...
const AchievementCard = ({ achievement, isUnlocked, progress, onClick }: AchievementCardProps) => {
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className={clsx(
              ...
              isUnlocked ? 'text-[var(--main-color)]' : 'text-[var(--secondary-color)]'
            )}>
              {achievement.title}
            </h3>
            ...
            <p className={clsx(
              ...
              isUnlocked ? 'text-[var(--secondary-color)]' : 'text-[var(--secondary-color)]/70'
            )}>
        ...
        {!isUnlocked && progress > 0 && (
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium text-[var(--main-color)]">Progress</span>
              <span className="text-sm font-bold text-[var(--main-color)]">{Math.round(progress)}%</span>
            </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-[var(--border-color)]/30">
          <div className="flex items-center gap-2">
            <Trophy size={16} className={isUnlocked ? 'text-yellow-500' : 'text-[var(--border-color)]'} />
            <span className={clsx(
              'text-sm font-bold',
              isUnlocked ? 'text-[var(--main-color)]' : 'text-[var(--secondary-color)]'
            )}>
...
const AchievementProgress = () => {
  ...
  const getAchievementProgress = (achievementId: string) => {
    ...
    switch (achievement.requirements.type) {
      ...
      case 'accuracy':
        ...
        current = totalAnswers > 0 ? (stats.allTimeStats.totalCorrect / totalAnswers) * 100 : 0;
        break;
    }
  ...
  const getCategoryStats = (categoryId: string) => {
    ...
    const categoryUnlocked = categoryAchievements.filter(a => unlockedAchievements[a.id]).length;
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <span className="text-sm font-medium text-[var(--main-color)]">Overall Progress</span>
                <span className="text-sm font-bold text-[var(--main-color)]">{Math.round(completionPercentage)}%</span>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {filteredAchievements.length === 0 && (
            <div className="text-center py-12">
              <Trophy className="mx-auto text-[var(--border-color)] mb-4" size={48} />
